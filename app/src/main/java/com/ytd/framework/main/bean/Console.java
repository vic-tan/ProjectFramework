...
public class Console  implements Serializable {
    ...
    public Console(String appName, boolean on_of_level, int random_max, boolean is_random, String timer_start, String timer_end, boolean is_start_timer) {
