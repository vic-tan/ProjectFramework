...
public class ExempleBaseAdpterChatMessage
{
	...
	public ExempleBaseAdpterChatMessage(int icon, String name, String content,
	...
	{
		return "ExempleBaseAdpterChatMessage [icon=" + icon + ", name=" + name + ", content="
